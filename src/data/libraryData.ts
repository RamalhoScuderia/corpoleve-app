...
export interface LibraryItem {
  ...
  iconName: string;
  badgeText?: string;
  type: 'guide' | 'substitutions' | 'habits' | 'faq' | 'navigation' | 'recipes_list';
...
export const LIBRARY_ITEMS: LibraryItem[] = [
  {
    ...
    description: 'Acervo premium com 30 receitas inéditas, práticas e leves que não aparecem no plano principal de 14 dias.',
  ...
  },
  {
    ...
    description: 'Aprenda como substituir alimentos mantendo o equilíbrio do plano.',
    ...
    substitutions: [
      {
        ...
        substitutes: ['Peixe grelhado (120g)', 'Carne magra (100g)', 'Tofu grelhado (130g)', '2 ovos cozidos']
      },
      {
        original: 'Batata-doce (100g)',
        substitutes: ['Mandioca (90g)', 'Inhame (100g)', 'Arroz integral (80g)', 'Abóbora cabotiá (150g)']
      },
      {
        original: 'Azeite de oliva (1 col. sopa)',
        substitutes: ['Abacate (30g)', 'Sementes de girassol (1 col. sopa)', 'Castanhas do Pará (2 unidades)']
      },
      {
        original: 'Leite vegetal de amêndoas (200ml)',
        substitutes: ['Leite de coco diluído (200ml)', 'Leite de aveia (200ml)', 'Iogurte natural desnatado (150g)']
      }
    ]
  },
  {
    ...
    description: 'Pequenos hábitos para continuar evoluindo após os 14 dias.',
  ...
  },
  {
    ...
    faqs: [
      {
        question: 'Posso substituir alguma refeição por outra receita do aplicativo?',
        answer: 'Sim! Desde que você escolha uma receita da mesma categoria (ex: trocar um café da manhã por outro café da manhã disponível no app).'
      },
      {
        question: 'O que fazer se sentir fome entre as refeições?',
        answer: 'Beba um copo de água ou chá sem açúcar. Se a fome persistir, opte por um snack leve como bastões de pepino/cenoura ou uma porção pequena de castanhas.'
      },
      {
        question: 'Posso tomar café durante o desafio?',
        answer: 'Sim, o café é permitido sem adição de açúcar refinado ou adoçantes artificiais em excesso.'
      },
      {
        question: 'Perdi um dia do desafio. Devo recomeçar do zero?',
        answer: 'Não! Apenas retome de onde parou no dia seguinte. O importante é a consistência a longo prazo, não a perfeição.'
      },
      {
        question: 'Como manter o peso leve após concluir os 14 dias?',
        answer: 'Você pode repetir o plano das semanas ou usar o guia de dicas e receitas para criar seus próprios cardápios mantendo os hábitos adquiridos.'
      }
    ]
  }
];
